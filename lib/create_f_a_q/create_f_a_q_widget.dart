...
class CreateFAQWidget extends StatefulWidget {
  ...
  @override
  _CreateFAQWidgetState createState() => _CreateFAQWidgetState();
}
...
class _CreateFAQWidgetState extends State<CreateFAQWidget> {
  ...
  void initState() {
    ...
    refNameController = TextEditingController();
    refURLController = TextEditingController();
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            final faqsCreateData = createFaqsRecordData(
