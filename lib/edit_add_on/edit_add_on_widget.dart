...
class EditAddOnWidget extends StatefulWidget {
  ...
  final AddOnsRecord? addOn;

  @override
  _EditAddOnWidgetState createState() => _EditAddOnWidgetState();
}

class _EditAddOnWidgetState extends State<EditAddOnWidget> {
  ...
  void initState() {
    super.initState();
    feeController = TextEditingController(text: widget.addOn!.fee?.toString());
    nameController = TextEditingController(text: widget.addOn!.name);
      ...
      appBar: AppBar(
        ...
        actions: [
          FlutterFlowIconButton(
            ...
            onPressed: () async {
              await widget.addOn!.reference.delete();
              context.pop();
            },
          ),
        ],
