...
class _$OrderServicesRecord extends OrderServicesRecord {
  ...
  _$OrderServicesRecord._({this.name, this.fee, this.quantity, this.ffRef})
      : super._();
  ...
  int get hashCode {
    return $jf($jc(
        $jc($jc($jc(0, name.hashCode), fee.hashCode), quantity.hashCode),
        ffRef.hashCode));
  }
  ...
  _$OrderServicesRecord _build() {
    final _$result = _$v ??
        new _$OrderServicesRecord._(
            name: name, fee: fee, quantity: quantity, ffRef: ffRef);
    replace(_$result);
    return _$result;
  }
}
