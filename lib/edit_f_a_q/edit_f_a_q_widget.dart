...
class EditFAQWidget extends StatefulWidget {
  ...
  @override
  _EditFAQWidgetState createState() => _EditFAQWidgetState();
}
...
class _EditFAQWidgetState extends State<EditFAQWidget> {
  ...
  void initState() {
    ...
    refNameController = TextEditingController(text: widget.faq!.referenceName);
    refURLController = TextEditingController(text: widget.faq!.referenceUrl);
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            final faqsUpdateData = createFaqsRecordData(
                              isActive: switchListTileValue,
                              question: questionController!.text,
                              answer: answerController!.text,
                              referenceName: refNameController!.text,
                              referenceUrl: refURLController!.text,
                            );
                            await widget.faq!.reference.update(faqsUpdateData);
                            context.pop();
                          },
                          text: 'Save',
